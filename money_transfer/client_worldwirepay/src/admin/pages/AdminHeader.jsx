        ...
        <div class="l-navbar " id="nav-bar">
          <nav class="nav">
            <div>
              ...
              <div class="nav_list">
                <a class="nav_link active" href="/">
                  <i class="bx bx-grid-alt nav_icon"></i>
                  <span class="nav_name">Dashboard</span>
                </a>
                <a class="nav_link false" href="/payment">
                  <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fas"
                ...
                <a class="nav_link false" href="/bank-payment">
                  <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fas"
                  ...
                  <span class="nav_name">Banks Payments</span>
                </a>
                <a class="nav_link false" href="/stored-data">
                  <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fas"
                    data-icon="indent"
                    class="svg-inline--fa fa-indent "
                    role="img"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 448 512"
                  >
                  ...
                  <span class="nav_name">Stored Data</span>
                </a>
                <a class="nav_link false" href="/manage-invoice">
                  <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fas"
                    data-icon="file-invoice"
                    class="svg-inline--fa fa-file-invoice "
                    role="img"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 384 512"
                  >
                  ...
                  <span class="nav_name">Manage Invoice</span>
                </a>
                <a class="nav_link false" href="/manage-brand">
                  <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fas"
                    data-icon="store"
                    class="svg-inline--fa fa-store "
                    role="img"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 576 512"
                  >
                  ...
                  <span class="nav_name">Brand Setting</span>
                </a>
                  ...
                  <div class="accordion-item">
                    ...
                    >
                      <div class="accordion-body">
                        <a class="nav_link false" href="/mobailBank/bKash">
                          <svg
                            aria-hidden="true"
                            focusable="false"
                            data-prefix="fas"
                            data-icon="mobile-screen"
                            class="svg-inline--fa fa-mobile-screen "
                            role="img"
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 384 512"
                          >
                          ...
                          <span class="nav_name">Mobail Bank</span>
                        </a>
                        <a class="nav_link false" href="/manage-bankTransfer">
                          <svg
                            aria-hidden="true"
                            focusable="false"
                            data-prefix="fas"
                          ...
                          <span class="nav_name">Bank Transfar</span>
                        </a>
                        <a
                          class="nav_link false"
                          href="/international-payment/paypal"
                        >
                          <svg
                            aria-hidden="true"
                            focusable="false"
                          ...
                          <span class="nav_name">International</span>
                        </a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="accordion-item">
                    ...
                    >
                      <div class="accordion-body">
                        <a
                          class="nav_link false"
                          href="/system-setting/app-setting"
                        >
                          <svg
                            aria-hidden="true"
                            focusable="false"
                          ...
                          <span class="nav_name">Android App</span>
                        </a>
                        <a
                          class="nav_link false"
                          href="/system-setting/templete"
                        >
                          <svg
                            aria-hidden="true"
                            focusable="false"
                          ...
                          <span class="nav_name">Templete</span>
                        </a>
                        <a
                          class="nav_link false"
                          href="/system-setting/custom-css"
                        >
                          <svg
                            aria-hidden="true"
                            focusable="false"
                            data-prefix="fas"
                            data-icon="file-code"
                            class="svg-inline--fa fa-file-code "
                            role="img"
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 384 512"
                          >
                          ...
                          <span class="nav_name">Custim CSS</span>
                        </a>
                        <a class="nav_link false" href="/system-setting/mail">
                          <svg
                            aria-hidden="true"
                            focusable="false"
                            data-prefix="fas"
                            ...
                            >
                              <div class="accordion-body">
                                ...
                                >
                                  ...
                                  <span class="nav_name">One Signal</span>
                                </a>
                                <a
                                  class="nav_link false"
                        ...
                        <a
                          class="nav_link false"
                          href="/system-setting/active-license"
                        >
                          <svg
                            aria-hidden="true"
                            focusable="false"
                          ...
                          <span class="nav_name">Active license</span>
                        </a>
                      </div>
                    </div>
                  </div>
                ...
                <div class="accordion" id="accordionExample">
                  <div class="accordion-item">
                    <p class="accordion-header" id="headingOne">
                      ...
                      >
                        <svg
                          ...
                          class="svg-inline--fa fa-puzzle-piece "
                          role="img"
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 512 512"
                        >
                    ...
                    >
                      <div class="accordion-body">
                        <a class="nav_link false" href="/sms-transaction">
                          <svg
                            aria-hidden="true"
                            focusable="false"
                            data-prefix="fas"
                          ...
                          <span class="nav_name">Sms Transaction</span>
                        </a>
                        <a class="nav_link false" href="/sms-setting/bulksmsbd">
                          <svg
                            aria-hidden="true"
                            focusable="false"
                            data-prefix="fas"
                          ...
                          <span class="nav_name">Sms List</span>
                        </a>
                      </div>
                    </div>
                  </div>
                ...
                <div class="accordion" id="accordionExample">
                  <div class="accordion-item">
                    <p class="accordion-header" id="headingOne">
                      ...
                      >
                        <svg
                          ...
                          class="svg-inline--fa fa-users-gear "
                          role="img"
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 640 512"
                        >
                    ...
                    >
                      <div class="accordion-body">
                        <a class="nav_link false" href="/role-user">
                          <svg
                            aria-hidden="true"
                            focusable="false"
                            data-prefix="fas"
                          ...
                          <span class="nav_name">Role Create</span>
                        </a>
                        <a class="nav_link false" href="/role-access">
                          <svg
                            aria-hidden="true"
                            focusable="false"
                            data-prefix="fas"
                          ...
                          <span class="nav_name">Role Access</span>
                        </a>
                      </div>
                    </div>
                  </div>
                </div>
                <a class="nav_link false" href="/theme-market">
                  <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fas"
                  ...
                  <span class="nav_name">Theme Market</span>
                </a>
                <a class="nav_link false" href="/change-password">
                  <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fas"
                ...
                <a class="nav_link false" href="/activities">
                  <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fas"
                ...
                <div class="accordion" id="accordionExample">
                  <div class="accordion-item">
                    ...
                    >
                      <div class="accordion-body">
                        <a class="nav_link " href="/general-setting">
                          <svg
                            aria-hidden="true"
                            focusable="false"
                            data-prefix="fas"
